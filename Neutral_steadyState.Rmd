...
I performed simulations with diferent initial conditions 
 0= "empty" initial conditions, this mimics the actual succession path
 1=  One individual of each species in the center 
 2=  "Filled" lattice filled with metacommunity frequency, 
 3=  "Ones" the center of the lattice with species 1.

The option 3 produces a faster fixation of the most competitive species, but the most realistic is the option=0 or option=2
...
```{r plotsimul256_64_L5_T20000Empty001, eval=F,echo=F,message=F,warning=F}
setwd("Simul")
...
## Time series simulations for side=256 time=20000 logseries metacomunity empty initial conditions  m=0.0001
...
## Time series simulations for side=256 time=10000 logseries metacomunity empty initial conditions  m=0.0001

```{r plotsimul256_64_L5_T10000Empty0001, eval=T,echo=F,message=F,warning=F}
setwd("Simul")
...
## Time series simulations for side=256 time=30000 logseries metacomunity empty initial conditions  m=0.0001

```{r plotsimul256_64_L5_T30000Empty0001, eval=T,echo=F,message=F,warning=F}
setwd("Simul")
...
## Time series simulations for side=256 time=30000 logseries metacomunity filled initial conditions   m=0.0001  

```{r plotsimul256_64_L5_T30000Filled0001, eval=F,echo=F,message=F,warning=F}
setwd("Simul")
...
## Time series simulations for side=256 time=10000 logseries metacomunity filled initial conditions   m=0.0001  

```{r plotsimul256_64_L5_T10000Filled0001, eval=F,echo=F,message=F,warning=F}
setwd("Simul")
...
## Time series simulations for side=256 time=5000 logseries metacomunity filled initial conditions   m=0.0001  

```{r plotsimul256_64_L5_T5000Filled0001, eval=F,echo=F,message=F,warning=F}
setwd("Simul")
...
## Time series simulations for side=256 time=3000 logseries metacomunity filled initial conditions   m=0.0001  

```{r plotsimul256_64_L5_T3000Filled0001, eval=F,echo=F,message=F,warning=F}
setwd("Simul")
...
```{r plotsimul256_64_L5_T20000Filled001, eval=F,echo=F,message=F,warning=F}
setwd("Simul")
...
ggplot(filter(CT,Side==512,Migr==0.0001), aes(x=Repl, y=meanH)) + geom_point(alpha=.2) + theme_bw() + scale_x_log10(breaks=c(0.003,0.02,0.1,1)) + stat_summary(fun.y=mean,geom="line",colour="red")+ facet_grid(Time ~ IniCond,scales="free_y" )+xlab(bquote(rho))  

ggplot(filter(CT,Side==256,Migr==0.0001), aes(x=Repl, y=meanH)) + geom_point(alpha=.2) + theme_bw() + scale_x_log10(breaks=c(0.0001,0.001,0.01,0.1,1)) + stat_summary(fun.y=mean,geom="line",colour="red")+ facet_grid(Time ~ IniCond,scales="free_y" )+xlab(bquote(rho)) +ylab("Mean H")
ggsave("figs/HvsRho_Time_64_256_L_Filled.png", width=4.5,height=6,units="in",dpi=600)

ggplot(filter(CT,Side==256,Time==20000), aes(x=Repl, y=meanH)) + geom_point(alpha=.2) + theme_bw() +  stat_summary(fun.y=mean,geom="line",colour="red")+ facet_grid(Migr ~ IniCond,scales="free_y" )+xlab(bquote(rho)) + scale_x_log10(breaks=c(0.0001,0.001,0.01,0.1,1))+ylab("Mean H")
ggsave("figs/HvsRho_T20000_64_256_L_IniCond.png", width=6,height=6,units="in",dpi=600)

ggplot(filter(CT,Side==256,Time==20000), aes(x=Repl, y=meanRich)) + geom_point(alpha=.2) + theme_bw() +  stat_summary(fun.y=mean,geom="line",colour="red")+ facet_grid(Migr ~ IniCond,scales="free_y" )+xlab(bquote(rho)) + ylab("Mean S")
ggsave("figs/SvsRho_T20000_64_256_L_IniCond.png", width=6,height=6,units="in",dpi=600)

ggplot(filter(CT,Side==256), aes(x=Repl, y=meanH)) + geom_point(alpha=.2) + theme_bw() +  stat_summary(fun.y=mean,geom="line",colour="red")+ facet_grid(Migr ~ IniCond,scales="free_y" )+xlab(bquote(rho)) + 
