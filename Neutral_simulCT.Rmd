...
#
rhoCritSide <- filter(rhoCritSide,ColonizationRate==m,DispersalDistance==26.66,MetaNsp==nsp)
rhoCritSide <- bind_rows(rhoCritSide,k$rCTs)

filter(rhoCritSide,ColonizationRate==m,DispersalDistance==26.66,MetaNsp==nsp)

# Create data frame to store CP for infinite lattices
rhoCrit <- filter(rhoCrit,ColonizationRate!=m,DispersalDistance==26.66,MetaNsp==nsp)
rhoCrit <- bind_rows(rhoCrit,k$rCT)
...
filter(rhoCrit,ColonizationRate==m)
...
With 30 repetitions
  ...
  MetaType DispersalDistance ColonizationRate     pcrit      pcSE MetaNsp  Time
     <chr>             <dbl>            <dbl>     <dbl>     <dbl>   <dbl> <dbl>
1        L             26.66            0.001 0.0007418 3.453e-05     320 20000
2        U             26.66            0.001 0.0005057 4.020e-05     320 20000

## Simulatios to Determine critical point for m=0.1 (NOT USED IN THE PAPER)
