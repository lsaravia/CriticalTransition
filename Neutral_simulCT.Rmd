...
# Make with different sides filter side=150
# 
k<-filter(rhoCritSide,Time==time,MetaNsp==nsp,DispersalDistance==round(mean_power(alfa),2),ColonizationRate==m)
k$MetaType <- factor(k$MetaType,labels=c("Logseries","Uniform"))
...
```{r gensimul_disp52_clu_side_64_meta_T20000m1, eval=T,echo=F,message=T,warning=T}
