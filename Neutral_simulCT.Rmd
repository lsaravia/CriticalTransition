...
p <-expand.grid(disp=alfa,migr=m,repl=ReplRate,side=c(128,256),meta=c("L","U")) 
...
ggsave("figs/RichvsRepl_T20000_64_side_meta_m0001.png", width=6,height=6,units="in",dpi=600)
...
ggsave("figs/RichvsRepl_T20000_64_side_meta_m0001_lin.png", width=6,height=6,units="in",dpi=600)
...
ggplot(mClusters, aes(x=ReplacementRate, y=SpanningProb)) + geom_point() + theme_bw() + scale_x_log10() + facet_grid(Side ~ MetaType ) +xlab(bquote(rho)) + geom_line(colour=colp[1]) + geom_vline(aes(xintercept=pcrit),k,colour=colp[6]) + ylab("Probability of spanning cluster")+  theme(axis.text.x=element_text(angle=-30, vjust=0.9,hjust = 0.1)) 
ggsave("figs/SpanPvsRepl_T20000_64_side_meta_m01.png", width=6,height=6,units="in",dpi=600)

#
# The same Plot in linear x scale 
#
ggplot(mClusters, aes(x=ReplacementRate, y=SpanningProb)) + geom_point() + theme_bw() + coord_cartesian(xlim=c(0, 0.05)) + facet_grid(Side ~ MetaType ) +xlab(bquote(rho)) + geom_line(colour=colp[1]) + geom_vline(aes(xintercept=pcrit),k,colour=colp[6]) + ylab("Probability of Spanning cluster")
ggsave("figs/SpanPvsRepl_T20000_64_side_meta_m01_lin.png", width=6,height=6,units="in",dpi=600)
...
#
ggplot(tClusters, aes(x=ReplacementRate, y=H)) + geom_point(alpha=.1) + theme_bw() + scale_x_log10() + stat_summary(fun.y=median,geom="line",colour=colp[1])+ facet_grid(Side ~ MetaType,scales="free_y" )+xlab(bquote(rho)) + geom_vline(aes(xintercept=pcrit),k,colour=colp[6])
ggsave("figs/HvsRepl_T20000_64_side_meta_m01.png", width=6,height=6,units="in",dpi=600)

#
# H vs rho in linear x scale 
#
ggplot(tClusters, aes(x=ReplacementRate, y=H)) + geom_point(alpha=.1) + theme_bw() + coord_cartesian(xlim=c(0, 0.1)) + stat_summary(fun.y=median,geom="line",colour=colp[1])+ facet_grid(Side ~ MetaType,scales="free_y" )+xlab(bquote(rho)) + geom_vline(aes(xintercept=pcrit),k,colour=colp[6]) + theme(panel.margin.x=unit(0.6, "lines"))
ggsave("figs/HvsRepl_T20000_64_side_meta_m01_lin.png", width=6,height=6,units="in",dpi=600)
...
ggsave("figs/RichvsRepl_T20000_64_side_meta_m01.png", width=6,height=6,units="in",dpi=600)

#
# Richness vs rho linear scale
#
ggplot(tClusters, aes(x=ReplacementRate, y=Richness)) + geom_point(alpha=.1) + theme_bw() + stat_summary(fun.y=mean,geom="line",colour=colp[1])+ facet_grid(Side ~ MetaType,scales="free_y" )+xlab(bquote(rho)) + geom_vline(aes(xintercept=pcrit),k,colour=colp[6])
ggsave("figs/RichvsRepl_T20000_64_side_meta_m01_lin.png", width=6,height=6,units="in",dpi=600)
...
ggsave("figs/SpanClusRepl_T20000_64_side_meta_m01.png", width=6,height=6,units="in",dpi=600)
...
## Determine critical point for m=0.1

```{r gensimul_clu_side_64_meta40_T20000m1, eval=T,echo=F,message=T,warning=T}
setwd("Simul")
...
ReplRate <- 0.0001
time <- 10000
p <-expand.grid(disp=alfa,migr=m,repl=ReplRate,side=c(192),meta=c("L")) 
...
ggplot(mClusters, aes(x=ReplacementRate, y=SpanningProb)) + geom_point() + theme_bw() + scale_x_log10() + facet_grid(Side ~ MetaType ) +xlab(bquote(rho)) + geom_line(colour=colp[1]) + geom_vline(aes(xintercept=pcrit),k,colour=colp[6]) + ylab("Probability of spanning cluster")+  theme(axis.text.x=element_text(angle=-30, vjust=0.9,hjust = 0.1)) 
ggsave("figs/SpanPvsRepl_T20000_64_side_meta_m1.png", width=6,height=6,units="in",dpi=600)

#
# The same Plot in linear x scale 
#
ggplot(mClusters, aes(x=ReplacementRate, y=SpanningProb)) + geom_point() + theme_bw() + coord_cartesian(xlim=c(0, 0.5)) + facet_grid(Side ~ MetaType ) +xlab(bquote(rho)) + geom_line(colour=colp[1]) + geom_vline(aes(xintercept=pcrit),k,colour=colp[6]) + ylab("Probability of Spanning cluster")
ggsave("figs/SpanPvsRepl_T20000_64_side_meta_m1_lin.png", width=6,height=6,units="in",dpi=600)
...
#
ggplot(tClusters, aes(x=ReplacementRate, y=H)) + geom_point(alpha=.1) + theme_bw() + scale_x_log10() + stat_summary(fun.y=median,geom="line",colour=colp[1])+ facet_grid(Side ~ MetaType,scales="free_y" )+xlab(bquote(rho)) + geom_vline(aes(xintercept=pcrit),k,colour=colp[6])
ggsave("figs/HvsRepl_T20000_64_side_meta_m1.png", width=6,height=6,units="in",dpi=600)

#
# H vs rho in linear x scale 
#
ggplot(tClusters, aes(x=ReplacementRate, y=H)) + geom_point(alpha=.1) + theme_bw() + coord_cartesian(xlim=c(0, 1)) + stat_summary(fun.y=median,geom="line",colour=colp[1])+ facet_grid(Side ~ MetaType,scales="free_y" )+xlab(bquote(rho)) + geom_vline(aes(xintercept=pcrit),k,colour=colp[6]) + theme(panel.margin.x=unit(0.6, "lines"))
ggsave("figs/HvsRepl_T20000_64_side_meta_m1_lin.png", width=6,height=6,units="in",dpi=600)
...
#
ggplot(tClusters, aes(x=ReplacementRate, y=Richness)) + geom_point(alpha=.1) + theme_bw() + scale_x_log10() + stat_summary(fun.y=mean,geom="line",colour=colp[1])+ facet_grid(Side ~ MetaType,scales="free_y") +xlab(bquote(rho)) + geom_vline(aes(xintercept=pcrit),k,colour=colp[6])
ggsave("figs/RichvsRepl_T20000_64_side_meta_m1.png", width=6,height=6,units="in",dpi=600)

#
# Richness vs rho linear scale
#
ggplot(tClusters, aes(x=ReplacementRate, y=Richness)) + geom_point(alpha=.1) + theme_bw() + stat_summary(fun.y=median,geom="line",colour=colp[1])+ facet_grid(Side ~ MetaType,scales="free_y" )+xlab(bquote(rho)) + geom_vline(aes(xintercept=pcrit),k,colour=colp[6])
ggsave("figs/RichvsRepl_T20000_64_side_meta_m1_lin.png", width=6,height=6,units="in",dpi=600)
...
# H vs rho in linear x scale 
#
ggplot(tClusters, aes(x=ReplacementRate, y=H)) + geom_point(alpha=.1) + theme_bw() + coord_cartesian(xlim=c(0, 0.5)) + stat_summary(fun.y=median,geom="line",colour=colp[1])+ facet_grid(ColonizationRate ~ MetaType,scales="free_y" )+xlab(bquote(rho)) + geom_vline(aes(xintercept=pcrit),k,colour=colp[6]) + theme(panel.margin.x=unit(0.6, "lines"))
...
#
mClusters <- filter(Clusters, ColonizationRate==m) %>% group_by(MetaNsp,Side,MetaType,ReplacementRate,DispersalDistance,ColonizationRate,Time) %>% summarise(n=n()) #%>% filter(n==50)
...
# Count number of simulations
#
kk <-filter(Clu,ColonizationRate==m) %>% group_by(MetaNsp,Side,MetaType,ReplacementRate,DispersalDistance,Time) %>% summarise(n=n())
kk <-filter(Clusters,ColonizationRate==m) %>% group_by(MetaNsp,Side,MetaType,ReplacementRate,DispersalDistance,Time) %>% summarise(n=n())

# Filter and replace
#
Clu <- filter(Clu,ColonizationRate==m)

Clusters <- filter(Clusters, !(ColonizationRate==m & ReplacementRate==ReplRate)) #%>% distinct()
...
# Filter simulations
#
#Clusters <- Clusters %>% filter(!(MetaNsp==nsp & DispersalDistance==alfa & ColonizationRate==m & Side==192 & ReplacementRate==0.0001 & MetaType=="L"))

rm(mClusters,p,kk,cn,cl,Clu,k,tClusters,rank)
