...
ReplRate <- c(0.0000,0.0001,0.0005,0.0006,0.0007,0.0008,0.0010,0.0020,0.0030,0.0040,0.0050,0.0060,0.0070,0.0080,0.0080,0.0100,0.0150,0.0200,0.0500,0.1000,0.3000,1) 
# 0.0090 have 40 simulations
...
Clusters <- filter(Clusters, ColonizationRate!=m) #%>% distinct()
